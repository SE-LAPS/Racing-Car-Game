...
public class Game extends JFrame implements KeyListener,ActionListener
{
	...
	else if(roadmove==1)
	{
		...
		car=new ImageIcon("./src/game/game/car5.png");
		...
		// opposite car
		car1=new ImageIcon("./src/game/game/car1.png");
		car2=new ImageIcon("./src/game/game/car3.png");
		car3=new ImageIcon("./src/game/game/car4.png");
		...
		g.drawString("😭 Game Over 😭",165, 270);
		g.setColor(Color.red);
		g.setFont(new Font("Arial",Font.BOLD,30));
